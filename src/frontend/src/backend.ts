...
export class Backend implements backendInterface {
    ...
    async addStudent(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addStudent();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getStudent(arg0: Principal): Promise<StudentView | null> {
        if (this.processError) {
            try {
    ...
    async saveQuizScore(arg0: string, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveQuizScore(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateStreak(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
